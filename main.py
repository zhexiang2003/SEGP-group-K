...
from detect_predict_image import run_seed_detection
...
if __name__ == '__main__':
    # subprocess를 먼저 실행합니다.
    run_subprocess()
    # subprocess가 끝난 후, main 창을 띄웁니다.
    subprocess.run(['time', '/t'], stdout=subprocess.PIPE, shell=True)
    mainFunction()
